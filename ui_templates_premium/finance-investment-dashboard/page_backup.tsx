...
import {
  ...
  CreditCard, Wallet, Target, BarChart3, Shield, AlertTriangle,
  Plus, Search, Filter, Download, Bell, Settings, ArrowUpRight,
  Activity, Zap, RefreshCw, Clock, CheckCircle, TrendingDown as TrendDown
} from 'lucide-react'

// Type-safe portfolio metrics with as const
...
const ALLOCATION_DATA = [
  { type: 'Stocks', value: 16500, allocation: 45, color: '#2563eb' },
  { type: 'Bonds', value: 7500, allocation: 20, color: '#10b981' },
  { type: 'Crypto', value: 4200, allocation: 12, color: '#8b5cf6' },
  { type: 'Real Estate', value: 8300, allocation: 23, color: '#f59e0b' },
] as const

const PERFORMANCE_DATA = [
  { month: 'Jan', portfolio: 32500, benchmark: 31800 },
  { month: 'Feb', portfolio: 33200, benchmark: 32100 },
  { month: 'Mar', portfolio: 33800, benchmark: 32500 },
  { month: 'Apr', portfolio: 34500, benchmark: 33200 },
  { month: 'May', portfolio: 35200, benchmark: 33800 },
  { month: 'Jun', portfolio: 36125, benchmark: 34500 },
] as const
